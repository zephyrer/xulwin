...
namespace XULWin
{
    ...
    namespace Windows
    {
        ...
        {
            if (boost::shared_ptr<Windows::Toolbar> ieToolbar = mToolbar.lock())
            {
        ...
        {
            mText = inText;
            boost::shared_ptr<Windows::Toolbar> toolbar = mToolbar.lock();
            if (toolbar)
            {
        ...
        {
            mImage = inImage;
            if (boost::shared_ptr<Windows::Toolbar> toolbar = mToolbar.lock())
            {
                toolbar->rebuildLayout();
            }
        }
